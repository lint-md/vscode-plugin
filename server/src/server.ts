...
documents.onDidChangeContent(change => {
  ...
  // fs.readFile(path.resolve('./.mdlintrc'), (data: any)=>{
  // 	// let rulesConfig = JSON.parse(data.toString()).rules
  // 	let rulesConfig = require(data.toString()).rules
  // 	validateTextDocument(change.document, rulesConfig)
  // })
})
